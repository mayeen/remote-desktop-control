...
class ClientCommandsSender implements KeyListener,
    ...
    public void mouseMoved(MouseEvent e) {
        double xScale = clientScreenDim.getWidth()/cPanel.getWidth();   //ekta scaling kortesi screen dimention er shathe 
        System.out.println("xScale: " + xScale);    //jpanel er, mouse movement accurate korar jonne
        double yScale = clientScreenDim.getHeight()/cPanel.getHeight();
        System.out.println("yScale: " + yScale);
        System.out.println("Mouse Moved");
        writer.println(EnumCommands.MOVE_MOUSE.getAbbrev());
        writer.println((int)(e.getX() * xScale)); //oi scale er value diye actual coordinate * for accurate mouse movement
